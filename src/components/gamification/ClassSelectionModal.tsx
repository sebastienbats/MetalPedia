...
export default function ClassSelectionModal({ isOpen, onClose }: Props) {
  ...
  // 🆕 États pour gérer le flux d'adoubement
  ...
  const handleConfirmSelection = () => {
    ...
    // 🆕 Au lieu de valider directement, on lance le quiz
    setInitiationState('quiz');
  };

  const handleQuizSuccess = () => {
    if (selectedPreview) {
      selectClass(selectedPreview); // C'est ici que la classe est vraiment attribuée
    }
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="metal-card w-full max-w-4xl max-h-[90vh] overflow-hidden border-2 border-metal-fire/50 flex flex-col">
        
        {/* En-tête */}
        <div className="p-6 border-b border-metal-gray bg-gradient-to-r from-metal-fire/10 to-transparent flex items-center justify-between">
          <div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {/* ⚠️ AVERTISSEMENT : Changement de voie */}
            ...
            <div className="bg-metal-fire/10 border border-metal-fire/50 rounded-lg p-4 mb-6 flex gap-3 items-start animate-fade-in">
              ...
              <div className="text-sm text-gray-300">
                ...
                <p>
                  ...
                  <br />
                  <span className="text-green-400 font-semibold">Rassurez-vous :</span> Votre progression globale et votre Panthéon des Anciens seront <strong className="text-white">intégralement conservés</strong>.
                </p>
              </div>
            </div>
          )}

          {/* 🆕 ÉCRAN D'ÉCHEC DE L'ADOUBEMENT */}
          {initiationState === 'failed' && selectedPreview && (
            <div className="text-center py-12 space-y-6 animate-fade-in">
              ...
              <p className="text-sm text-gray-400 italic max-w-md mx-auto leading-relaxed">
                ...
                <br /><br />
                Explore davantage ce pilier, gagne en expérience, et reviens quand tu seras prêt à affronter l'épreuve. »
              </p>
              <button
        ...
        {/* Footer (Uniquement visible en mode sélection) */}
        {initiationState === 'selecting' && (
