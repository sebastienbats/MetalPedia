...
export const SYMBOL_FAMILIES = {
  nordic: ['✴', '.　 ۫ ·', 'ᚠ', 'ᚢ', 'ᚦ', 'ᚨ', 'ᚱ', 'ᚲ', 'ᚷ', 'ᚹ', 'ᚺ', 'ᚾ', 'ᛁ', 'ᛃ', 'ᛇ', 'ᛈ', 'ᛉ', 'ᛊ', 'ᛏ', 'ᛒ', 'ᛖ', 'ᛗ', 'ᛚ', 'ᛜ', 'ᛞ', 'ᛟ', 'ⵣ', 'ϟ', 'ꖦ', '↟', 'ᛦ', 'ᚺ'],
  musical: ['✴', '.　 ۫ ·', '♩', '♪', '♫', '♬', '♭', '♮', '♯', '𝄞', '𝄢', '𝄡', '𝄞⨾𓍢ִ໋', '𝄩', '𝄂𝅦𝄚𝄞', '𝄫', '𑣲𝄞', '𝄞𝄢', 'ִ࿐𝄞𝄢℘', '݁♬⋆.˚𝄞', '𝄞⨾𓍢ִ໋', '𝄞𝄢'],
  cosmic: ['✴', '.　 ۫ ·', '✦', '✧', '★', '☆', '✶', '✴', '✹', '✵', '✷', '✸', '☄', '✺', '✯', '✰', '✡', '∞'],
  alchemical: ['✴', '.　 ۫ ·', '☉', '☽', '♁', '♂', '♀', '☿', '♃', '♄', '⚕', '⚗', '⚚', '🜁', '🜂', '🜃', '🜄', '🜔'],
  occult: ['✴', '.　 ۫ ·', '☯', '☸', '✡', '☥', '⛤', '⚕', '☬', '☫', '☪', '✝', '☦', '⚚', '♅', '♆', '♇', '⚝', '𖤝', '𓅇', '🕷', '𖤝', '👁', '🕸️'],
  medieval: ['✴', '.　 ۫ ·', '⚔', '🗡', '➳', '🛡', '⚜', '♆', '⚐', '✠', '☨', '⛨', '⚚', '𑣿', '𓌖', '𖤍', '🗝'],
  elements: ['✴', '.　 ۫ ·', '△', '▽', '▷', '◁', '◇', '○', '□', '⬡', '⬢', '⬣', '⬤', '⬥', '⬦', '⬧', '⬨', '⬩'],
  death: ['✴', '.　 ۫ ·', '☠', '⚰', '⚱', '🜝', '🜞', '🜟', '🜠', '🜡', '🜢', '🜣', '🜤', '🜥', '🜦', '🜧', '🜨', '🜩'],
  celestial: ['✴', '.　 ۫ ·', '♋︎', '♐︎', '♌︎', '♏︎', '♒︎', '♓︎', '♍︎', '♈︎', '♊︎', '♎︎︎', '♉︎', '♑︎', '☉', '☽'],
  black: ['✴', '.　 ۫ ·', '⏾', '☽', '☾', '⛧', '⚰', '✟', '☠', '⛤', '✞', '☥', '♰', 'ꪉꪉꪉ', '𓂀', '𖦹', '🜤', '🜠'],
  thrash: ['✴', '.　 ۫ ·', '☣', '⚔', '☢︎', '♨', '☠', '🗲', '⛓', '⛏', '⚒', '🗡', '⚑', '⚐', '☄', '✹', '✦', '𖦏'],
  folk: ['✴', '.　 ۫ ·', '𖧧', '☘', '𖣂︎', '⚔', '♪', '♫', 'ᚠ', 'ᚱ', 'ᛊ', 'ᛏ', 'ᛟ', '☘', '⚘', '❦', '❧', '✤', '༄', '𐂂', '𓏢'],
  mixed: ['✴', '.　 ۫ ·', 'ᚠ', 'ᚦ', 'ᚱ', 'ᛟ', '♪', '♫', '𝄞', '♩', '✦', '★', '✶', '☄', '☉', '☽', '♂', '♀', '☯', '☥', '⛤', '⚔', '⚒', '🗡', '△', '◇', '☘'],
} as const;
...
export default function FloatingRunes({
  ...
  // 🛡️ Fallback robuste sur window.innerWidth pour garantir le rendu même si le parent est à 0
