    ...
    <div ref={wrapperRef} className="relative w-full" role="search">
      ...
      {hasSuggestions && (
        <ul
          ...
          ref={listRef}
          role="listbox"
          className="absolute z-50 w-[calc(100%+10rem)] -left-4 sm:w-full sm:left-0 mt-2 metal-card max-h-80 overflow-y-auto border border-metal-gray rounded-lg shadow-2xl"
        >
